...
export default function MarqueeStrip() {
  const marqueeText =
    'FOUNDED BY SMT. Vydehi • 100% PRESERVATIVE-FREE • FROM ₹800 TO GLOBAL KITCHENS • SHIPPED TO USA, AUSTRALIA & CANADA • TIME-HONORED IYENGAR TRADITIONS • SENIOR CITIZEN DABBA CARE • SLOW IRON-ROASTED SPICES • MYSURU HERITAGE • ';
